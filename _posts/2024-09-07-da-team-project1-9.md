...
| 지하철역    | subway_df107       | 2023-01-01~2023-09-30 일별 지하철역별 시간대별(06시이전, 1시간간격 18개, 24시이후, 총20개 컬럼) 노인 승차/하차 인원수 | [공공데이터포털](https://www.data.go.kr/data/15101985/fileData.do)                    |                                                                      | 2023년 일평균 지하철역별 (평일/토요일/일요일) & (승차/하차) & 시간대별(20개) 노인 인원수(3*2*20 = 120개), 역코드, 총 승하차인원수 (총 122개) |
